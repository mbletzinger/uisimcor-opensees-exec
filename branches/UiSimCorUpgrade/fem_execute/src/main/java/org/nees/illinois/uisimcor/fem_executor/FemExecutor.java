...
public class FemExecutor {
	 ...
	 */
	private final Map<String, SubstructureExecutorI> executors = new HashMap<String, SubstructureExecutorI>();
	 ...
	 */
	public final Map<String, SubstructureExecutorI> getExecutors() {
		return executors;
	}
